...
import com.rayole.offerpro.sdk.LinkOMagicData;
...
public final class OfferProSdkModule extends ReactContextBaseJavaModule {
    ...
    @ReactMethod public void showLinkOMagic(String url, Promise promise) { runActivity(promise, a -> OfferProSdk.getInstance().showLinkOMagic(a, url)); }
    ...
    @ReactMethod public void fetchLinkOMagic(Promise p) { try { OfferProSdk.getInstance().fetchLinkOMagic(o -> p.resolve(o == null ? null : offer(o))); } catch (Throwable t) { p.reject("LINK_MAGIC_FAIL", t); } }
    ...
    private WritableMap offer(LinkOMagicData o) {
        WritableMap map = Arguments.createMap();
        map.putInt("id", o.getId()); map.putString("name", o.getName()); map.putString("description", o.getDescription());
        map.putString("offer_image", o.getOfferImage()); map.putString("est_time", o.getEstTime());
        map.putDouble("reward_coins", o.getRewardCoins()); map.putString("source", o.getSource());
        map.putString("offer_link", o.getOfferLink()); map.putString("direct_offer_link", o.getDirectOfferLink()); return map;
    }
